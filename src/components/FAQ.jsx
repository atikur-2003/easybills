  ...
  return (
    <div className="my-20 max-w-11/12 mx-auto">
      <div className="text-center my-10">
        <h1 className="text-2xl md:text-3xl text-[#0c2f54] font-bold">
          Frequently Asked Question
        </h1>
      </div>
      <div className="bg-[#E6F1F8]">
        ...
        <div className="collapse collapse-arrow  border border-base-300">
          ...
          <div className="collapse-content text-base text-gray-600">
            After logging in, go to the "Bills" page, choose the bill you want
            to pay, and click the “Pay” button. Then, select a card and confirm
            your payment. The amount will be deducted from your balance.
          </div>
        </div>
        <div className="collapse collapse-arrow border border-base-300">
          <input type="radio" name="my-accordion-2" />
